...
- 用户可以查看自己的 AI 历史结果。
- AI 历史结果可以覆盖简历诊断、目标岗位解析、匹配分析、岗位优化建议、局部改写等类型。
- 用户可以按简历查看关联 AI 结果。
- 用户可以按目标岗位查看关联 AI 结果。
- 用户可以查看某条 AI 结果详情。
...
| 来源 | 说明 |
|---|---|
| resume_ai_analyses | 简历诊断结果 |
| job_descriptions | 目标岗位解析结果 |
| ai_job_match_results | 匹配分析结果 |
| ai_resume_suggestions | 岗位优化建议结果 |
| ai_rewrite_suggestions | AI 局部改写结果 |
